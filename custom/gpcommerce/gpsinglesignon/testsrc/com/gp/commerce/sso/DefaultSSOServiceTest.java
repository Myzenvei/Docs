...
import static com.gp.commerce.sso.SSOServiceTestConstants.ADMIN_GROUP;
import static com.gp.commerce.sso.SSOServiceTestConstants.EMPLOYEE_GROUP;
import static com.gp.commerce.sso.SSOServiceTestConstants.EMPLOYEE_TYPE_NAME;
import static com.gp.commerce.sso.SSOServiceTestConstants.FALSE;
import static com.gp.commerce.sso.SSOServiceTestConstants.SSO_PROPERTY_PREFIX;
import static com.gp.commerce.sso.SSOServiceTestConstants.SSO_USER_GROUP;
import static com.gp.commerce.sso.SSOServiceTestConstants.SSO_USER_GROUP_2;
import static com.gp.commerce.sso.SSOServiceTestConstants.SSO_USER_ID;
import static com.gp.commerce.sso.SSOServiceTestConstants.SSO_USER_NAME;
import static com.gp.commerce.sso.SSOServiceTestConstants.TRUE;
...
//import com.gp.commerce.sso.model.SamlUserGroupModel;
...
public class DefaultSSOServiceTest extends ServicelayerTransactionalTest
{
	...
	@Resource(name = "defaultGpSSOUserService")
	private DefaultGPSSOService defaultSSOService;
	@Resource
	...
	{
		// given
		Config.setParameter(DefaultGPSSOService.SSO_DATABASE_USERGROUP_MAPPING, FALSE);
		createMappingInProperties(SSO_USER_GROUP, EMPLOYEE_TYPE_NAME, EMPLOYEE_GROUP);

		// when
		final UserModel user = defaultSSOService.getOrCreateSSOUser(SSO_USER_ID, SSO_USER_NAME, newHashSet(SSO_USER_GROUP), soldTo,
				email, true);
	...
	public void shouldThrowIllegalArgumentExceptionWhenNoRoleFound()
	{
		...
		// when
		defaultSSOService.getOrCreateSSOUser(SSO_USER_ID, SSO_USER_NAME, newHashSet(SSO_USER_GROUP), soldTo, email, true);
	}
	...
	public void shouldThrowIllegalArgumentExceptionWheAmbigousRoleFound()
	{
		...
		// when
		defaultSSOService.getOrCreateSSOUser(SSO_USER_ID, SSO_USER_NAME, newHashSet(SSO_USER_GROUP, SSO_USER_GROUP_2), soldTo,
				email, true);
	}
	...
	public void shouldThrowIllegalArgumentExceptionWhenIdEmpty()
	{
		...
		// when
		defaultSSOService.getOrCreateSSOUser(StringUtils.EMPTY, SSO_USER_NAME, newHashSet(SSO_USER_GROUP), soldTo, email, true);
	}
	...
	public void shouldThrowIllegalArgumentExceptionWhenIdNameEmpty()
	{
		...
		// when
		defaultSSOService.getOrCreateSSOUser(SSO_USER_ID, StringUtils.EMPTY, newHashSet(SSO_USER_GROUP), soldTo, email, true);
	}
	...
	{
		// given
		Config.setParameter(DefaultGPSSOService.SSO_DATABASE_USERGROUP_MAPPING, TRUE);
	...
	public void shouldMergeUserGroupsOfMultipleMappingsFromDatabase()
	{
		...
		final UserModel ssoUser = defaultSSOService.getOrCreateSSOUser(SSO_USER_ID, SSO_USER_NAME,
				newHashSet(SSO_USER_GROUP, SSO_USER_GROUP_2), soldTo, email, true);
