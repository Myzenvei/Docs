...
public interface SAMLUtil
{
	...
	void setCookie(final HttpServletResponse response, final HttpServletRequest request,String cookieName,String cookieValue);
	
	void expireCookies(final HttpServletResponse response, final HttpServletRequest request, String soldTo);
}
