...
public class DefaultSAMLUtilTest extends ServicelayerTest
{
	...
	public void setup()
	{
		Config.setParameter(GpsinglesignonConstants.SSO_USERID_KEY, SSO_USERID_KEY);
		Config.setParameter(GpsinglesignonConstants.SSO_FIRSTNAME_KEY, SSO_FIRSTNAME_KEY);
		Config.setParameter(GpsinglesignonConstants.SSO_LASTNAME_KEY, SSO_LASTNAME_KEY);
