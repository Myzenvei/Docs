...
/**
 * Global class for all Gpsamlbackoffice constants. You can add global constants for your extension into this class.
 */
public final class GpssobackofficeConstants extends GeneratedGpssobackofficeConstants
{
	public static final String EXTENSIONNAME = "gpssobackoffice";
	...
	public static final String SSO_DEFAULT_COOKIE_NAME = "LoginToken";
	...
	public static final String SSO_COOKIE_NAME = "sso.backoffice.cookie.name";

	public static final String SSO_PASSWORD_ENCODING = "sso.password.encoding";

	public static final String SSO_REDIRECT_URL = "sso.backoffice.redirect.url";
