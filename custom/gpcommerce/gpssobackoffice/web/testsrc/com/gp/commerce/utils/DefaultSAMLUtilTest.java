...
public class DefaultSAMLUtilTest extends ServicelayerTest
{
	...
	public void setup()
	{
		Config.setParameter(GpssobackofficeConstants.SSO_USERID_KEY, SSO_USERID_KEY);
		Config.setParameter(GpssobackofficeConstants.SSO_FIRSTNAME_KEY, SSO_FIRSTNAME_KEY);
		Config.setParameter(GpssobackofficeConstants.SSO_LASTNAME_KEY, SSO_LASTNAME_KEY);
