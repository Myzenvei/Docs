...
(function () {
  "use strict";
  var C = {
    BasePath: "https://s4cloudlpihe4b6c67a.us3.hana.ondemand.com/elastic-access/sap/lpi/odata/sap/CUAN_CONTENT_PAGE_RESULT_SRV/",
    ResultHeadersPath: "ResultHeaders",
    CORS: true,
    CSRFTokenHeader: "",
    AppendScenarioParameter: "_L54AD1F204_",
    Tenant: "my300760-api.s4hana.ondemand.com",
    Version: "11.8.7"
  };
  var c;
  var R = {
    ...
    initialize: function () {
      ...
      for (i = 0; i < a.length; i++) {
        this.ContentPage.prepare(a[i]);
      }
      this.Request.fetchToken(a, this.handleFetchTokenResponse.bind(this));
    },
    handleFetchTokenResponse: function (a, n) {
      var i;
      if (n) {
        for (i = 0; i < a.length; i++) {
          this.Result.sendOpen(a[i], this.handleOpenResponse.bind(this));
        }
      } else {
        for (i = 0; i < a.length; i++) {
          R.ContentPage.toggleErrorMessage(a[i], true);
        }
      }
    },
    handleOpenResponse: function (o, r) {
      if (R.Request.isErrorResponse(r)) {
        R.ContentPage.toggleErrorMessage(o, true);
      } else {
        this.ContentPage.finishLoading(o, r);
      }
      o.sapCpInitializing = false;
      o.sapCpInitialized = true;
    },
    isInitializing: function () {
      var a = this.getPages(),
        i;
      for (i = 0; i < a.length; i++) {
        if (a[i].sapCpInitializing) {
          return true;
        }
      }
      return false;
    ...
    reset: function () {
      ...
      c = null;
      for (i = 0; i < a.length; i++) {
        delete a[i].sapCpInitializing;
        delete a[i].sapCpInitialized;
      }
    },
    ContentPage: {
      prepare: function (o) {
        if (o.sapCpInitializing || o.sapCpInitialized) {
          return;
        }
        o.sapCpInitializing = true;
        this.checkVersion(o);
        this.prepareWidgets(o);
        R.Event.registerListener(o, "submit", this.handleSubmitEvent.bind(this));
      },
      checkVersion: function (o) {
        var s = R.Setting.get(o, "version");
        if (s > C.Version) {
          R.Console.warn("You are using an outdated version of the landing page script");
        }
      },
      prepareWidgets: function (o) {
        var w = this.getWidgets(o),
          i;
        for (i = 0; i < w.length; i++) {
          R.Widget.prepare(w[i]);
        }
      },
      getWidgets: function (o) {
        return R.Node.getAllWithClassName(o, "sapCpWidget");
      },
      checkMissingMandatoryFieldsLabel: function (n) {
        var o = R.Util.findParentByClassName(n, "sapCpContentPage"),
          ...
          h = (m.length > 0);
        R.ContentPage.toggleMissingMandatoryField(o, h);
      },
      finishLoading: function (o, r) {
        if (r && r.ContactPersonalizationData && r.ContactPersonalizationData.results) {
          this.processPersonalizationData(o, r.ContactPersonalizationData.results);
        }
        this.toggleLoading(o, false);
      },
      processPersonalizationData: function (o, p) {
        var P, w = this.getWidgets(o),
          W, i;
      ...
      toggleLoading: function (o, s) {
        R.CSS.toggleClass(o, "sapCpContentPageLoading", s);
      },
      toggleMissingMandatoryField: function (o, s) {
        R.CSS.toggleClass(o, "sapCpMissingMandatoryField", s);
      },
      toggleInvalid: function (o, i) {
        R.CSS.toggleClass(o, "sapCpContentPageInvalid", i);
      },
      toggleErrorMessage: function (o, s) {
        R.CSS.toggleClass(o, "sapCpSubmitError", s);
      },
      toggleSuccessMessage: function (o, s) {
        R.CSS.toggleClass(o, "sapCpSubmitCompleted", s);
      },
      toggleSpinnerVisibility: function(spinner) {
        R.CSS.toggleClass(spinner, "spinner-hidden");
      },
      isProductiveTestMode: function (o) {
        var t = R.Setting.get(o, "test-mode"),
          p = R.Setting.get(o, "productive");
        return (t && p);
      },
      setErrorMessage: function (o, e) {
        var E = R.Node.getFirstWithClassName(o, "sapCpErrorMessageText");
        if (E) {
    ...
    Widget: {
      ...
      collectAnswer: function (w, o) {
        ...
        if (this.isInputWidget(w)) {
          ...
          a = R.ButtonWidget.collectAnswer(w, o);
        } else if (this.isInteractionWidget(w)) {
    ...
    InputWidget: {
        ...
        if (I) {
          ...
          if (v !== "00000000") {
            var y = R.Node.getFirstWithClassName(d, "sapCpDatePickerYear"),
              ...
              b = R.Node.getFirstWithClassName(d, "sapCpDatePickerDay");
            if (y) {
      ...
      updateDatePickerValues: function (d) {
        ...
        if (O > f) {
          ...
          for (I = O; I < f; I++) {
            g = I + 1;
            this.addDatePickerDropDownOption(D, g);
          }
        }
      },
    ...
    CheckBoxWidget: {
      prepare: function (o) {
        ...
        if (a) {
          R.Event.registerListener(a, "focusout", this.handleCheckBoxFocusOutEvent.bind(this));
        }
      },
      applyPersonalization: function (o, v) {
        var a;
        a = o.getElementsByTagName("input")[0];
        if (a) {
          a.checked = (a.checked || !!v);
        }
      },
      handleCheckBoxFocusOutEvent: function (e) {
        var o = e.target,
          a = R.Util.findParentByClassName(o, "sapCpCheckBoxWidget");
        if (o.checked) {
          R.Widget.toggleMissingMandatory(a, false);
        }
        R.ContentPage.checkMissingMandatoryFieldsLabel(a);
      },
      collectAnswer: function (o) {
        var i = R.Widget.isMandatory(o),
          a = o.getElementsByTagName("input")[0],
          b = false;
        if (a) {
        ...
        var A = {
          WidgetKeyHash: R.Setting.get(o, "key"),
          WidgetValueKeyHash: "",
          Value: (b ? "X" : "")
        };
        return A;
    ...
    DownloadWidget: {
      prepare: function (d) {
        ...
        if (a[0]) {
          R.Event.registerListener(a[0], "focusout", this.handleCheckBoxFocusOutEvent.bind(this));
        }
      },
      handleCheckBoxFocusOutEvent: function (e) {
        var o = e.target,
          d = R.Util.findParentByClassName(o, "sapCpDownloadWidget");
        if (o.checked) {
    ...
    InteractionWidget: {
      ...
      handleCheckBoxFocusOutEvent: function (e) {
        var o = e.target,
          i = R.Util.findParentByClassName(o, "sapCpInteractionWidget");
        if (o.checked) {
          R.Widget.toggleMissingMandatory(i, false);
        }
        R.ContentPage.checkMissingMandatoryFieldsLabel(i);
    ...
    ButtonWidget: {
      ...
      performFollowUpAction: function (b, o, f) {
        ...
        if (!F || F === R.Constants.FollowUpAction.FollowUpPage) {
          ...
          R.ContentPage.toggleSuccessMessage(o, true);
        }
      },
    ...
    Result: {
      sendOpen: function (o, f) {
        var p = (R.Setting.get(o, "prefill-data") === "true"),
          O = R.Result.buildOpen(o, p);
        R.Request.postResult(O, function (r) {
          f(o, r);
        });
        if (!p) {
          f(o);
      ...
      sendSubmit: function (o) {
        var spinner = document.querySelector('.ymkt-form-spinner');
        if(spinner) {
          R.ContentPage.toggleSpinnerVisibility(spinner);
        }
        var a = R.Util.findParentByClassName(o, "sapCpContentPage"),
          s = R.Result.buildSubmit(a, o),
          v = true;
        R.ContentPage.toggleErrorMessage(a, false);
        R.ContentPage.toggleSuccessMessage(a, false);
        if (a.checkValidity) {
          v = a.checkValidity();
          R.ContentPage.toggleInvalid(a, !v);
          if (a.reportValidity) {
            a.reportValidity();
          }
        }
        if (v && s) {
          R.ContentPage.toggleMissingMandatoryField(a, false);
          R.ButtonWidget.toggleLoading(o, true);
          R.Request.postResult(s, function (r) {
            R.Result.handleSubmitResponse(r, a, o);
            R.ButtonWidget.toggleLoading(o, false);
          });
        } else {
          R.ContentPage.toggleMissingMandatoryField(a, true);
          if(spinner) {
            R.ContentPage.toggleSpinnerVisibility(spinner);
          }
        }
      },
      buildOpen: function (o, p) {
        var r = this.build("OPEN", o);
        if (p) {
          r.ContactPersonalizationData = [];
        }
        return r;
      },
      buildSubmit: function (o, a) {
        var r, A, m;
        r = this.build("SUBMIT", o);
        A = R.ContentPage.collectAnswers(o, a);
        m = !A;
        R.ContentPage.toggleMissingMandatoryField(o, m);
        if (m) {
          return null;
        }
        r.Answers = A;
      ...
      build: function (e, o) {
        var l = o.getElementsByClassName("sapCpLayout")[0];
        var r = {
          ResultEvent: e,
          ContentPageKeyHash: R.Setting.get(o, "key"),
          LayoutKeyHash: R.Setting.get(l, "key"),
          Url: R.Util.getCurrentUrl()
        };
        if (R.ContentPage.isProductiveTestMode(o)) {
      ...
      handleSubmitResponse: function (r, o, a) {
        if (R.Request.isErrorResponse(r)) {
          var e = (r.error && r.error.message && r.error.message.value);
          R.Console.warn(e);
          R.ContentPage.toggleErrorMessage(o, true);
          return;
        }
        if (r.ResultValues && r.ResultValues.results) {
          this.handleResultValues(r.ResultValues.results, a);
        }
        var spinner = document.querySelector('.ymkt-form-spinner');
        if(spinner) {
          R.ContentPage.toggleSpinnerVisibility(spinner);
        }
        R.ButtonWidget.performFollowUpAction(a, o, r.FollowUpPage);
      },
      handleResultValues: function (r, o) {
        var m, i;
        for (i = 0; i < r.length; i++) {
          m = r[i];
          if (m.WidgetValueName === R.Constants.WidgetValueName.DownloadURI) {
            this.handleDownloadURI(m, o);
          }
        }
      },
    ...
    Request: {
      ...
      appendScenarioParameter: function (p) {
        var P = p,
          m = R.getConfig();
      ...
      fetchToken: function (a, f, u) {
        var m = R.getConfig(),
          h = (u ? "GET" : "HEAD"),
          H = this.build(h, m.BasePath);
        if (!m.CSRFTokenHeader) {
          f(a, true);
          return;
        }
        this.send(H, null, function () {
          if (H.getResponseHeader) {
            var n = H.getResponseHeader(m.CSRFTokenHeader);
            if (n) {
              c = n;
            }
          }
      ...
      postResult: function (r, f) {
        var s = C.BasePath + C.ResultHeadersPath,
          h = this.build("POST", s);
    ...
    Node: {
      getAllWithClassName: function (n, s) {
        if (n.getElementsByClassName) {
          return n.getElementsByClassName(s);
        }
      ...
      getFirstWithClassName: function (n, s) {
        var N = R.Node.getAllWithClassName(n, s);
        if (N && N[0]) {
          return N[0];
        }
        return null;
    ...
    CSS: {
      ...
      toggleClass: function (n, s, a) {
        var A = a;
        if (typeof A === "undefined") {
          A = !this.hasClass(n, s);
        }
        if (A) {
          return this.addClass(n, s);
        }
        return this.removeClass(n, s);
      }
    },
    Util: {
      findParentByClassName: function (n, s) {
        if (!n || !s) {
          return null;
        }
        if (R.CSS.hasClass(n, s)) {
          return n;
        }
        var p = n.parentNode;
        if (!p || p === n) {
        ...
        return this.findParentByClassName(p, s);
      },
