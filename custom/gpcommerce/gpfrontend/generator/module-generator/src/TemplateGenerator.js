  ...
  _createClass(TemplateGenerator, [
      ...
      value: function _create() {
        ...
        if (options.isDir) {
          this._createDirectory(
            ...
            { name: name, actions: actions, filesType: filesType },
            filesType,
          );
        } else {
    ...
    },
    {
      ...
      value: function _createFile(name, type, fileType, tpl) {
        _fsExtra2.default.outputFile(
          this._createFilePath(name, type, fileType),
          tpl,
          function(err) {
    ...
    },
    {
      ...
      value: function _createDirectory(dirPath, data, fileTypes) {
        ...
        _fsExtra2.default.readdir(dirPath, function(err, dir) {
          var name = data.name;
          var defaultPath = 'src/components/';
          var folder = _path2.default.join(process.cwd(), defaultPath, name);
          var filePath = void 0;
          ...
          dir.forEach(function(tempFile) {
            ...
            var fileFolders = fileName.split('/');
            fileName = fileFolders[fileFolders.length - 1];
    ...
    },
    {
      ...
      value: function _getSingleTpl(type) {
        ...
        return (
          this.TEMPLATES_DIR + '/' + type + '/temp.' + type + '.' + extension
        );
      },
