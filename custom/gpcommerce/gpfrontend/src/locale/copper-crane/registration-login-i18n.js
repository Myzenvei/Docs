const registrationLogin = {
  ...
  login: {
    ...
    b2berror190:
      'Oops. Something went wrong. You may have mistyped your password. However, due to a system upgrade, all users are required to reset their password once. If you have not done that yet, please use the Forgot Password link to reset your password.',
  ...
  passwordExpiry: {
    ...
    passwordDescription1:
      'Sorry, but that password reset link is incorrect no longer valid. If you still need to reset your password, please enter your email address below to request a new link.',
