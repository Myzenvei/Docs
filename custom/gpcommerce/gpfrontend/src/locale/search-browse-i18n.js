const searchBrowse = {
  ...
  searchResult: {
    ...
    addToCartError: 'Some of the selected products are currently not available and cannot be added to the cart.',
    bulkAddToCartError: 'All of the selected products are currently not available and cannot be added to the cart.',
    guestList: 'Guest List',
    selectAList: {
      selectListHeading: 'Select a List',
      createNewListLabel: 'Create New List',
