import common from './../gp-employee/common-i18n';
import registrationLogin from './registration-login-i18n';
import manageShoppingCart from './manage-shoppping-cart-i18n';
import quickOrder from './../gp-employee/quick-order-i18n';
import manageB2BOrg from './../gp-employee/manage-b2b-org-i18n';
import viewSiteContent from './../gp-employee/view-site-content-i18n';
...
import nfr from './../gp-employee/nfr-i18n';
import manageTransactionHistory from './../gp-employee/manage-transaction-history-i18n';
...
const messages = {
  'en-US': {
    ...
    pdpProductInfo: {
      ...
      content: 'Fill out the information below to send an email with information about this product.',
      ...
      disclaimerLine1: 'For consumers and customers located in the European Economic Area (EEA):',
      disclaimerLine2: 'Georgia-Pacific subscribes to the Safe Harbor privacy principles.',
      ...
      pdfDownload: {
        basicInformation: 'Fill out any of the following information to include on the PDF',
        ...
        onlyOnFirstPageDescription: 'Only display headlines on the first page of the PDF',
        ...
        disclaimerLine1: 'For consumers and customers located in the European Economic Area (EEA):',
        disclaimerLine2: 'Georgia-Pacific subscribes to the Safe Harbor privacy principles.',
        disclaimerLine3: 'Please visit our Safe Harbor Privacy Policy to learn how you can exercise and amend your choices.',
        resetLink: 'Reset Form',
      },
      imageDownload: {
        imageDownloadDescription: 'Fill out any of the download options below.',
        imageDownloadcontent: 'Note: Downloading time will increase with more images',
