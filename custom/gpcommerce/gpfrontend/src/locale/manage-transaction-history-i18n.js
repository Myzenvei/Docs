const manageTransactionHistory = {
  ...
  orderDetails: {
    ...
    cancelOrderSuccessMsg: 'You order is currently being processed for cancellation',
    cancelOrderText: 'Sometimes people change their minds. We’d be happy to cancel your order for you.\n Are you sure?',
    orderDetailsHeading: 'Order Details',
    giveAwayCoupon: 'You\'ve earned the following coupon!',
    orderNumber: 'Order Number',
    thankYou: 'Thank you for your Order!',
    orderEmail: "Your order is complete. We'll send you an email confirmation shortly.",
    order: 'Order',
    orderPlaced: 'Order Placed',
  ...
  orderApprovals: {
    ...
    b2bApprovalSortOptions: {
      options: [
        ...
        {
          label: 'Order Date Old First',
          value: '2-asc',
        },
        {
          label: 'Order placed by A to Z',
          value: '4-asc',
        },
        {
          label: 'Order placed by Z to A',
          value: '4-dsc',
        },
        {
          label: '# of Products High to Low',
          value: '5-asc',
        },
        {
          label: '# of Products Low to High',
          value: '5-dsc',
        },
        {
