...
/**
 * This is the extension manager of the Subscriptionaddon extension.
 */
public class SubscriptionaddonManager extends GeneratedSubscriptionaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SubscriptionaddonManager.class.getName());
	 ...
	 */
	public static SubscriptionaddonManager getInstance()
	{
		return (SubscriptionaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SubscriptionaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SubscriptionaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SubscriptionaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SubscriptionaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SubscriptionaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
