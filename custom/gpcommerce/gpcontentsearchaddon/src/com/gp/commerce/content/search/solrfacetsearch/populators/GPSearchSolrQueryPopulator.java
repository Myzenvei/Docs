...
public class GPSearchSolrQueryPopulator<INDEXED_PROPERTY_TYPE, INDEXED_TYPE_SORT_TYPE> implements
...
{
	private static final Logger LOG = Logger.getLogger(GPSearchSolrQueryPopulator.class);
	...
	private GPSolrFacetSearchConfigSelectionStrategy gpsolrFacetSearchConfigSelectionStrategy;
	@Resource(name = "cmsUtilService")
	private DefaultCMSUtilService defaultCMSUtilService;

	/**
	 * @return the gpsolrFacetSearchConfigSelectionStrategy
	 */
	public GPSolrFacetSearchConfigSelectionStrategy getGpsolrFacetSearchConfigSelectionStrategy()
	{
		return gpsolrFacetSearchConfigSelectionStrategy;
	}

	/**
	 * @param gpsolrFacetSearchConfigSelectionStrategy
	 *           the gpsolrFacetSearchConfigSelectionStrategy to set
	 */
	public void setGpsolrFacetSearchConfigSelectionStrategy(
			final GPSolrFacetSearchConfigSelectionStrategy gpsolrFacetSearchConfigSelectionStrategy)
	{
		this.gpsolrFacetSearchConfigSelectionStrategy = gpsolrFacetSearchConfigSelectionStrategy;
	}
	...
	/**
	 * Select the first content catalog version that has a SolrFacetSearchConfig
	 *
	 * @deprecated Since 5.0.
	 * @return the selected CatalogVersionModel
	 */
	@Deprecated
	protected CatalogVersionModel getSessionContentCatalogVersion()
	{
		for (final CatalogVersionModel catalogVersion : getSessionContentCatalogVersions())
		{
	...
	/**
	 * Get all the session catalog versions that belong to content catalogs of the current site.
	 *
	...
	protected Collection<CatalogVersionModel> getSessionContentCatalogVersions()
	{
		...
		{
			if (defaultCMSUtilService.isContentCatalog(sessionCatalogVersion.getCatalog()))
			{
	...
	{
		final SolrFacetSearchConfigModel solrFacetSearchConfigModel = gpsolrFacetSearchConfigSelectionStrategy
