...
/**
 * The Class DefaultGpsaporderexchangeb2bService.
 */
public class DefaultGpsaporderexchangeb2bService implements Gpsaporderexchangeb2bService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultGpsaporderexchangeb2bService.class);
	...
	{
		return DefaultGpsaporderexchangeb2bService.class.getResourceAsStream("/gpsaporderexchangeb2b/sap-hybris-platform.png");
	}
