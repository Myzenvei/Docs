...
import com.gpsaporderexchangeb2b.service.impl.DefaultGpsaporderexchangeb2bService;
 ...
 */
@IntegrationTest
public class DefaultGpsaporderexchangeb2bServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "gpsaporderexchangeb2bPlatformLogo";

		// when
		final String logoUrl = gpsaporderexchangeb2bService.getHybrisLogoUrl(logoCode);
