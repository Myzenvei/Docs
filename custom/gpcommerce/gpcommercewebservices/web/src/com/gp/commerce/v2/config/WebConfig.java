 ...
 */
package com.gp.commerce.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.gp.commerce.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "gpcommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "gpcommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "gpcommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "gpcommercewebservices.v2.description";
	private static final String TITLE = "gpcommercewebservices.v2.title";
	private static final String VERSION = "gpcommercewebservices.v2.version";
