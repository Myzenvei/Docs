 ...
 */
package com.gp.commerce.swagger;
...
{ @ApiImplicitParam(name = "baseSiteId", value = "Base site identifier", required = true, dataType = "String", paramType = "path"),
		...
		@ApiImplicitParam(name = "wishlistId", value = "Wishlist identifier: wishlist code for logged in user", required = true, dataType = "String", paramType = "path") })
public @interface ApiBaseSiteIdUserIdAndWishlistIdParam
{
	//empty
}
