 ...
 */
package com.gp.commerce.cronjob;
...
import com.gp.commerce.model.OldCartRemovalCronJobModel;
...
public class OldCartRemovalJob extends AbstractJobPerformable<OldCartRemovalCronJobModel>
{
	...
	private static final int DEFAULT_ANONYMOUS_CART_MAX_AGE = de.hybris.platform.util.Config.getInt("default.anonymous.cart.max.age", 7200);
