...
module.exports = function() {
    ...
    return {
        targets: [
            'otmmsmartedit',
            'otmmsmarteditcommons',
            'otmmsmarteditContainer'
        ],
        config: function(data, conf) {
            ...
            conf.otmmsmartedit = generateConfigForFolder('otmmsmartedit');
            conf.otmmsmarteditcommons = generateConfigForFolder('otmmsmarteditcommons');
            conf.otmmsmarteditContainer = generateConfigForFolder('otmmsmarteditContainer');
