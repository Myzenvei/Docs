    ...
    return {
        ...
        config: function(data, baseConf) {
            ...
            function generateConfigFromFolderName(folderName) {
                return {
                    src: [
                        targetBase + "otmmsmarteditcommons/**/*.js",
            ...
            baseConf.otmmsmartedit = generateConfigFromFolderName("otmmsmartedit");
            baseConf.otmmsmarteditContainer = generateConfigFromFolderName("otmmsmarteditContainer");
