...
import com.gpintegration.service.impl.DefaultGpintegrationService;
 ...
 */
@IntegrationTest
public class DefaultGpintegrationServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "gpintegrationPlatformLogo";

		// when
		final String logoUrl = gpintegrationService.getHybrisLogoUrl(logoCode);
