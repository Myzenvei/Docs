 ...
 */
package com.gp.ymkt.segmentation.evaluators;
 ...
 *
 */
public class GPCampaignRestrictionEvaluator implements CMSRestrictionEvaluator<CMSYmktCampaignRestrictionModel>
{
	private static final Logger LOG = LoggerFactory.getLogger(GPCampaignRestrictionEvaluator.class);
