...
/**
 * The Class DefaultGpintegrationService.
 */
public class DefaultGpintegrationService implements GpintegrationService
{
	private static final String CODE = "code";

	private static final String SAP_HYBRIS_PLATFORM_PNG = "sap-hybris-platform.png";

	private static final Logger LOG = LoggerFactory.getLogger(DefaultGpintegrationService.class);
	...
	public void createLogo(final String logoCode)
	{
		...
		media.setRealFileName(SAP_HYBRIS_PLATFORM_PNG);
	...
	{
		return DefaultGpintegrationService.class.getResourceAsStream("/gpintegration/sap-hybris-platform.png");
	}
