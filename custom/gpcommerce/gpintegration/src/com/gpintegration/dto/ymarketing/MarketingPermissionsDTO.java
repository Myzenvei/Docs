...
public class MarketingPermissionsDTO {
	...
	return new ToStringBuilder(this).append("Id",id).append("IdOrigin",idOrigin).append("Timestamp",timestamp).append("OptIn",optIn).append("OutboundCommunicationMedium",outboundCommunicationMedium).append("CommunicationDirection",communicationDirection).toString();
	}
}
