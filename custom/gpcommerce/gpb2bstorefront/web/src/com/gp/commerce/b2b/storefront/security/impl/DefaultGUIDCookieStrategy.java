...
import com.gp.commerce.b2b.storefront.interceptors.beforecontroller.RequireHardLoginBeforeControllerHandler;
	...
	public void setCookie(final HttpServletRequest request, final HttpServletResponse response)
	{
		...
		if (LOG.isInfoEnabled())
		{
			if(LOG.isDebugEnabled()){
				LOG.debug("Setting guid cookie and session attribute: " + guid);
			}
		}
	}
