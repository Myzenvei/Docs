...
import com.gp.commerce.b2b.storefront.filters.cms.CMSSiteFilter;
...
public class CmsPageBeforeViewHandler implements BeforeViewHandler
{
	...
	protected String buildCssClasses(final AbstractPageModel page)
	{
		...
		String cssClasses = CSS_CODE_PREFIX + page.getUid().replaceAll(regEx, "-") + ' ' +
		CSS_TYPE_PREFIX + page.getTypeCode().replaceAll(regEx, "-") +' ' +
		CSS_TEMPLATE_PREFIX + getViewForPage(page).replaceAll(regEx, "-") + ' ';
		...
		if (ContentPageModel.class.equals(page.getClass()))
		{
			...
			{
				cssClasses = cssClasses + CSS_LABEL_PREFIX + contentPage.getLabel().replaceAll(regEx, "-");
			}
		}
