 ...
 */
package com.gp.commerce.b2b.storefront.security.evaluator.impl;
...
import com.gp.commerce.b2b.storefront.security.evaluator.SecurityTraitEvaluator;
			...
			if (guidCookieName.equals(cookie.getName()))
			{
				...
				else
				{
					if(LOG.isDebugEnabled()){
						LOG.debug("Found secure cookie with invalid value. expected [" + guid + "] actual [" + cookie.getValue()
							+ "]. removing.");
					}
