...
public class GPSessionResetFilter extends OncePerRequestFilter
{
	...
	{
		LOG.debug("Inside Storefront GPSessionResetFilter");
		...
		final Cookie secureCookie = WebUtils.getCookie(request, GpcommerceFacadesConstants.ACC_SECURE_GUID_COOKIE);
