...
/**
 * Filter that initializes the session for the gpb2bstorefront. This is a spring configured filter that is
...
public class StorefrontFilter extends OncePerRequestFilter
{
			...
			final FilterChain filterChain) throws IOException, ServletException
	{
		...
		if(null == sessionService.getAttribute(GpcommerceCoreConstants.SOLD_TO_ID) && null == sessionService.getAttribute("soldToRootcategory"))
		{
			sessionService.setAttribute("soldToRootcategory", "DEFAULT");
			sessionService.setAttribute("soldToUnitId", "DEFAULT");
		}
