...
import com.gp.commerce.b2b.storefront.security.cookie.CustomerLocationCookieGenerator;
...
public class PickupInStoreController extends AbstractSearchPageController
{
	...
	protected String generatedUserLocationDataString(final UserLocationData userLocationData)
	{
		...
		if (geoPoint != null)
		{
			latitudeAndLongitudeString = geoPoint.getLatitude() +
					CustomerLocationCookieGenerator.LATITUDE_LONGITUDE_SEPARATOR + geoPoint.getLongitude();
		}

		final String builder = userLocationData.getSearchTerm() + CustomerLocationCookieGenerator.LOCATION_SEPARATOR +
