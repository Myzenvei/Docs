...
import com.gp.commerce.b2b.storefront.security.impl.WebHttpSessionRequestCache;
...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/gpb2bstorefront/electronics/en",
						"https://electronics.local:9002/gpb2bstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/gpb2bstorefront/electronics/en",
						"https://electronics.local:9002/gpb2bstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/gpb2bstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/gpb2bstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/gpb2bstorefront/electronics/en",
						"https://electronics.local:9002/gpb2bstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/gpb2bstorefront",
						"https://electronics.local:9002/gpb2bstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/gpb2bstorefront",
						"https://electronics.local:9002/gpb2bstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/gpb2bstorefront/electronics/en",
						"https://electronics.local:9002/gpb2bstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
