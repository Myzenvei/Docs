...
<head>
  ...
  <title>Dixie&reg; Foodservice</title>
  <link rel="stylesheet" type="text/css" href="https://cloud.typography.com/6228154/6448192/css/fonts.css">
  <link rel="icon" href="/gp/_ui/responsive/theme-alpha/images/dixie/favicon.ico" sizes="16x16" type="image/png">
  <style type="text/css">
    html,
    body {
      margin: 0;
  ...
  <div class='container'>
    <header>
      <div class="header-inner-wrapper">
        <a href="/"><img class='logo' src="${contextPath}/gp/_ui/responsive/common/images/dixie-color.svg"></a>
      </div>
    </header>
