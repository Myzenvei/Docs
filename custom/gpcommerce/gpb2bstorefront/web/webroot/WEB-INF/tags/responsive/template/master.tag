...
<body class="${pageBodyCssClasses} ${cmsPageRequestContextData.liveEdit ? ' yCmsLiveEdit' : ''} language-${fn:escapeXml(currentLanguage.isocode)}">
   ...
   <%-- Add resize event to window for smartedit preview pages. --%>
    <script type="text/javascript">
        if (window.location.pathname && (window.location.pathname.indexOf('preview-content')>=0 || location.href.indexOf('cmsTicketId') >= 0)) {
