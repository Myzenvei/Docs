...
<c:choose>
	<c:when test="${wro4jEnabled}">
		...
		<script type="text/javascript" src="${contextPath}/_ui/addons/hybrisanalyticsaddon/responsive/common/js/hybrisanalyticsaddon.js"></script>
...
<script type="text/javascript">
	...
	var piwikTrackerUrl="${contextPath}/events";
	...
	function trackContinueCheckoutClick_piwik(cartData) {
...
<noscript><p><img src="${piwikTrackerUrl}?idsite=${piwikSiteId}" style="border:0;" alt="" /></p></noscript>
		...
		<c:choose>
			...
			<c:when test="${siteUid == 'b2bwhitelabel'}">
				<script type="text/javascript" src="${commonResourcePath}/dist/static/js/b2b-white-label.js"></script>
			</c:when>
