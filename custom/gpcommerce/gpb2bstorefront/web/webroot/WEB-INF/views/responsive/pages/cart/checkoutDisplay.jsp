...
<c:choose>
    <c:when test="${enablesamplecart == true}">
        <vx-sample-cart-checkout :i18n="messages.manageShoppingCart.cartCheckout" :order-sample-redirect-url="'${orderSampleCartRedirectUrl}'"></vx-sample-cart-checkout>
    </c:when>
    <c:otherwise>
        <vx-cart-checkout :i18n="messages.manageShoppingCart.cartCheckout" />
    </c:otherwise>
</c:choose>
<!--
