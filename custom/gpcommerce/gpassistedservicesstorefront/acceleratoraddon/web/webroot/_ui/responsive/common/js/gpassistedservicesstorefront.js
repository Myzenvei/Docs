...
function addASMHandlers() {
   ...
   //         resetSession();
    ...
    $("#_asmPersonifyForm input[name='customerName'], input[name='customerId']").focus(function() {
...
ACC.gpassistedservicesstorefront = {
...
$(function(){
    if($(".js-ASM-collapseBtn").length > 0){
		...
		//bind event for toogle the asm panel
		$(document).on('mouseup click', '.js-ASM-collapseBtn', function(e) {
			e.preventDefault()
			if (!onDragging) {
				if ($('#_asm').hasClass('asm-collapsed')) {
					$('#_asm').removeClass('asm-collapsed')
