...
<div class="row overview-tab-charts">
    <div class="col-sm-12 devices-used-chart">
        ...
        <script type="application/javascript">
            ...
            ACC.gpassistedservicesstorefront.buildArrayValues(labels, '${device.deviceName}');
            ACC.gpassistedservicesstorefront.buildArrayValues(values, '${device.value}');
            </c:forEach>
            ACC.gpassistedservicesstorefront.drawDoughnutChart("${canvasId}", labels, values);
        </script>
    </div>
</div>
