...
public class AdditionalInformationController
{
	...
	private static final String CUSTOMER_360_PAGE = "addon:/gpassistedservicesstorefront/pages/customer360";
	private static final String CUSTOMER_360_FRAGMENT_404_PAGE = "addon:/gpassistedservicesstorefront/fragments/customer360/fragment404";
	private static final String CUSTOMER_360_SECTION = "addon:/gpassistedservicesstorefront/pages/section";
		...
		@RequestParam("sectionId") final String sectionId, final HttpServletResponse response)
	{
		...
		model.addAttribute(AIF_AJAX_TIMEOUT, Integer.valueOf(Config.getInt(GpassistedservicesstorefrontConstants.AIF_TIMEOUT,
				GpassistedservicesstorefrontConstants.AIF_DEFAULT_TIMEOUT)));
