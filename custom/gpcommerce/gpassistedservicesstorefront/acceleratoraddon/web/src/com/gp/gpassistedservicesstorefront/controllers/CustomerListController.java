...
public class CustomerListController extends AbstractSearchPageController
{
	...
	public String getCustomersListPopup(final Model model, final HttpServletResponse response)
	{
		...
		return GpassistedservicesstorefrontControllerConstants.Views.Fragments.CustomerListComponent.ASMCustomerListPopup;
	}
			...
			@RequestParam(value = "query", required = false) final String query)
	{
		...
		return GpassistedservicesstorefrontControllerConstants.Views.Fragments.CustomerListComponent.ASMCustomerListTable;
	}
