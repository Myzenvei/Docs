 ...
 */
package com.gp.gpassistedservicesstorefront.redirect.impl;
...
public class DefaultAssistedServiceRedirectStrategy implements AssistedServiceRedirectStrategy
{
	...
	{
		return Config.getString(GpassistedservicesstorefrontConstants.REDIRECT_ERROR, DEFAULT_ERROR_REDIRECT);
	}

	protected String getPathWithCart()
	{
		return Config.getString(GpassistedservicesstorefrontConstants.REDIRECT_WITH_CART, DEFAULT_CART_REDIRECT);
	}

	protected String getPathCustomerOnly()
	{
		return Config.getString(GpassistedservicesstorefrontConstants.REDIRECT_CUSTOMER_ONLY, DEFAULT_CUSTOMER_REDIRECT);
	}

	protected String getPathWithOrder(final String redirectOrderId)
	{
		return String.format(Config.getString(GpassistedservicesstorefrontConstants.REDIRECT_WITH_ORDER, DEFAULT_ORDER_REDIRECT),
				redirectOrderId);
	}
