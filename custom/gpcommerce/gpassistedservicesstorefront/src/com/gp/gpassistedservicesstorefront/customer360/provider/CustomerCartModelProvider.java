 ...
 */
package com.gp.gpassistedservicesstorefront.customer360.provider;
...
public class CustomerCartModelProvider implements FragmentModelProvider<CartData>
{
	...
	public CartData getModel(final Map<String, String> parameters)
	{
		...
		final int limit = Config.getInt(GpassistedservicesstorefrontConstants.AIF_OVERVIEW_CART_ITMES_TO_BE_DISPLAYED,
				GpassistedservicesstorefrontConstants.AIF_OVERVIEW_CART_ITMES_TO_BE_DISPLAYED_DEFAULT);
