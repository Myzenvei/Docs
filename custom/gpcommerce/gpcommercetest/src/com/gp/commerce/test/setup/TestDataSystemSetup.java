 ...
 */
package com.gp.commerce.test.setup;
...
import com.gp.commerce.test.constants.GpcommerceTestConstants;
import com.gp.commerce.test.orders.AcceleratorTestOrderData;


/**
 * This class provides hooks into the system's initialization and update processes.
 */
@SystemSetup(extension = GpcommerceTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/gpcommercetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/gpcommercetest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/gpcommercetest/import/cstickets.impex");
			...
			importImpexFile(context, "/gpcommercetest/import/csquotes.impex");

			LOG.info("Creating sample view site page for all 3 catalogs");
			importImpexFile(context, "/gpcommercetest/import/gpvanityfair-viewsitecontent.impex");
			importImpexFile(context, "/gpcommercetest/import/gppro-viewsitecontent.impex");
			importImpexFile(context, "/gpcommercetest/import/gpemployee-viewsitecontent.impex");

			LOG.info("Creating Color Codes...");
			importImpexFile(context, "/gpcommercetest/import/colorCodes.impex");

			LOG.info("Creating GP Attribute Config...");
			importImpexFile(context, "/gpcommercetest/import/GPAttributeConfig.impex");
		}
	}
}
