...
import com.hybris.ymkt.gpsapymktexpressway.services.Product1708SyncService;
import com.hybris.ymkt.gpsapymktexpressway.services.TestTool;



@ManualTest
public class Product1708SyncJobTest extends AbstractSyncJobTest<ProductSyncJob>
{
	protected static final String APPLICATION_JSON = "application/json";

	private static final Logger LOG = LoggerFactory.getLogger(Product1708SyncJobTest.class);
	...
	@Resource(name = "ymktProduct1708SyncJob")
	ProductSyncJob product1708SyncJob;
	...
	{
		return this.product1708SyncJob;
	}
	...
	public void setUp() throws Exception
	{
		...
		TestTool.fixLogger(Product1708SyncService.class);
	}
