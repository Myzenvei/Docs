...
public class GPClickStreamListener extends AbstractEventListener<AbstractTrackingEvent>
{
	private static final Logger LOG = LoggerFactory.getLogger(GPClickStreamListener.class);
	...
	protected AbstractTrackingEvent enrich(final AbstractTrackingEvent event)
	{
		...
		if (customerId != null && !customerId.isEmpty())
		{
			try
			{
				...
				{
					event.setYmktContactId(StringUtils.isNotEmpty(customers.get(0).getContactEmail())?customers.get(0).getContactEmail():event.getPiwikId());
