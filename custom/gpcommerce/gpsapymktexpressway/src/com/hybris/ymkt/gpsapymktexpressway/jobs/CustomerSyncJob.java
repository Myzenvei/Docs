...
import com.hybris.ymkt.gpsapymktexpressway.services.CustomerSyncService;


public class CustomerSyncJob extends AbstractChildSyncJob<SyncCronJobModel, CustomerModel, AddressModel, CustomerSyncService>
{
	...
	{
		return Optional.of("{item.uid} != 'anonymous'");
	}
