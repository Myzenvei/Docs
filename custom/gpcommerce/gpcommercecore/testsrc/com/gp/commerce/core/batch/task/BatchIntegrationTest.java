 ...
 */
package com.gp.commerce.core.batch.task;
...
{
	private static final String GP_US = "gpUSProductCatalog";
	...
	public void setUp() throws Exception
	{
		...
		importCsv("/gpcommercecore/test/testBatch.impex", "utf-8");
	...
	public void testBasicProduct() throws Exception
	{
		...
		Assert.assertEquals("gpUSProductCatalog", product.getCatalogVersion().getCatalog().getId());
	}
	...
	public void testPrice() throws Exception
	{
		...
		try
		{
			...
			Assert.assertEquals("gpUSProductCatalog", prize.getCatalogVersion().getCatalog().getId());
		}
		finally
		{
	...
	public void testMedia() throws Exception
	{
		...
		Assert.assertEquals("gpUSProductCatalog", container.getCatalogVersion().getCatalog().getId());
	}
	...
	public void testVariant() throws Exception
	{
		processFile(productId, "base_product-", new ProductContent()
		{
			...
			public void writeContent(final PrintWriter writer) throws IOException
			{
				writer.print("GPCommerceSizeVariantProduct");
		...
		final GPCommerceSizeVariantProductModel variant = (GPCommerceSizeVariantProductModel) productService.getProductForCode(variantId
				.toString());
		Assert.assertEquals("GPCommerceSizeVariantProduct", product.getVariantType().getCode());
	...
	protected void verifyMedia(final MediaModel media, final String format)
	{
		...
		Assert.assertEquals("gpUSProductCatalog", media.getCatalogVersion().getCatalog().getId());
