...
public class GPProductMaterialStatusValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider{
	...
	protected List<FieldValue> createFieldValue(final ProductModel product, final IndexedProperty indexedProperty) {
		...
		final MaterialStatusEnum materialStatus = product.getMaterialStatus();
		if (materialStatus != null) {
			addFieldValues(fieldValues, indexedProperty, materialStatus.getCode());
		}
