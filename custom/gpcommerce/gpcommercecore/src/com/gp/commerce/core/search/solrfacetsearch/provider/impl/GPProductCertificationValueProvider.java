...
public class GPProductCertificationValueProvider extends GPPropertyFieldValueProvider implements FieldValueProvider{
	...
	protected List<FieldValue> createFieldValue(final ProductModel product, final LanguageModel language,
		...
		{
			super.addFieldValues(fieldValues, indexedProperty, language, true);
		}
