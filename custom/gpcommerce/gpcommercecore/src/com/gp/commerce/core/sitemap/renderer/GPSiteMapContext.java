 ...
 */
package com.gp.commerce.core.sitemap.renderer;
...
/**
 * Site map context to render Site Map template
 */
public class GPSiteMapContext extends VelocityContext
{
	...
	{
		this.put(BASE_URL, getSiteBaseUrlResolutionService().getWebsiteUrlForSite(site, "", true, ""));
