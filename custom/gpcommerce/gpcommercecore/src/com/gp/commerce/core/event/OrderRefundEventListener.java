...
public class OrderRefundEventListener extends GPAbstractAcceleratorSiteEventListener<OrderRefundEvent>
{
	...
	protected void onSiteEvent(final OrderRefundEvent event)
	{
		...
		orderProcessModel.setRefundAmount(event.getProcess().getRefundAmount());
	...
	@Override
	protected SiteChannel getSiteChannelForEvent(OrderRefundEvent event) {
