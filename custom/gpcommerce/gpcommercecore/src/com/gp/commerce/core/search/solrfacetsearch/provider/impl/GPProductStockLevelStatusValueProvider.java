 ...
 * status.
 */
public class GPProductStockLevelStatusValueProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider
{
			...
			final IndexedProperty indexedProperty)
	{
		...
		if (baseStore != null)
		{
			...
			{
				addFieldValues(fieldValues, indexedProperty, stockLevelStatus.getCode());
			}
		}
		else
		{
			addFieldValues(fieldValues, indexedProperty, StockLevelStatus.INSTOCK.getCode());
		}
