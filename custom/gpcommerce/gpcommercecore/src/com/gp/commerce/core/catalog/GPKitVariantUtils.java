...
public class GPKitVariantUtils {

    private static final Logger LOGGER = Logger.getLogger(GPKitVariantUtils.class);
    ...
    public List<ProductModel> createGPVariants(List<GPProductKitModel> products) {
        ...
        GPProductKitModel baseProduct = null;
        ...
        try {
            ...
            for (ProductModel product : products) {
                if (baseProduct == null) {
                    ...
                    baseProduct = setupBaseProduct((GPProductKitModel) product);
                    productModelClones.add(baseProduct);

                }
                if (!containsVariant(product, baseProduct)) {
                	GPVariantProductKitModel genericVariantProductModel = convertToVariant(product, baseProduct);
    ...
    protected GPProductKitModel setupBaseProduct(GPProductKitModel product) {

    	GPProductKitModel baseProduct = product;
    ...
    protected GPVariantProductKitModel convertToVariant(ProductModel product, ProductModel baseProduct) {
        ...
        GPVariantProductKitModel genericVariantProductModel = modelService.clone(product,
        		GPVariantProductKitModel.class, null);

        //remove product stg/online
        removeGPKitProduct(product);
    ...
    private void removeGPKitProduct(ProductModel product) {
