...
import com.gp.commerce.core.suggestion.dao.SimpleSuggestionDao;
...
public class DefaultSimpleSuggestionDao extends AbstractItemDao implements SimpleSuggestionDao
{
			...
			final Integer limit)
	{
		...
		String builder = REF_QUERY_CATEGORY_START;
		if (excludePurchased)
		{
			builder = builder + REF_QUERY_SUB;
		}
		if (CollectionUtils.isNotEmpty(referenceTypes))
		{
			builder = builder + REF_QUERY_TYPES;
			params.put(REF_QUERY_PARAM_TYPES, referenceTypes);
		}
		builder = builder + REF_QUERY_CATEGORY_ORDER;
			...
			final Integer limit)
	{
		...
		final Map<String, Object> params = new HashMap<String, Object>();
		String builder = REF_QUERY_PRODUCT_START;
		if (excludePurchased)
		{
			builder = builder + REF_QUERY_SUB;
		}
		...
		builder = builder + REF_QUERY_PRODUCT_GROUP + REF_QUERY_PRODUCT_ORDER;
			...
			final ProductReferenceTypeEnum referenceType, final boolean excludePurchased, final Integer limit)
	{
		...
		{
			builder = builder + REF_QUERY_TYPE;
