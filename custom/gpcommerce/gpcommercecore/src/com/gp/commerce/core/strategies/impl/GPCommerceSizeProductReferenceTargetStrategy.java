 ...
 */
public class GPCommerceSizeProductReferenceTargetStrategy implements ProductReferenceTargetStrategy
{
	...
	public ProductModel getTarget(final ProductModel sourceProduct, final ProductReferenceModel reference)
	{
		...
		if (sourceProduct instanceof GPCommerceSizeVariantProductModel
				&& reference.getTarget() instanceof GPCommerceStyleVariantProductModel)
		{
			...
			if (CollectionUtils.containsAny(sourceSuperCategories, targetSuperCategories))
			{
				...
				final String size = ((GPCommerceSizeVariantProductModel) sourceProduct).getSize();
	...
	protected VariantProductModel getVariantWithSameSize(final ProductReferenceModel reference, final String size) {
		...
		{
			if (variant instanceof GPCommerceSizeVariantProductModel
					&& size.equals(((GPCommerceSizeVariantProductModel) variant).getSize()))
			{
				return variant;
			}
		}
