 ...
 */
package com.gp.commerce.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(GpcommerceFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(GpcommerceFulfilmentProcessConstants.PARENT_PROCESS);
