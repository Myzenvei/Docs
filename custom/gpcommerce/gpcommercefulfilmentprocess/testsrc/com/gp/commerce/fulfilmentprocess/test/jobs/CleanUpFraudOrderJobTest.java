 ...
 */
package com.gp.commerce.fulfilmentprocess.test.jobs;
...
import com.gp.commerce.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = GpcommerceFulfilmentProcessConstants.ORDER_PROCESS_NAME;
