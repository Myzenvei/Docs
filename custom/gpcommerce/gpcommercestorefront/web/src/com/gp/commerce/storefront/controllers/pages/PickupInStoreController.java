...
import com.gp.commerce.storefront.security.cookie.CustomerLocationCookieGenerator;
...
public class PickupInStoreController extends AbstractSearchPageController
{
	...
	protected String generatedUserLocationDataString(final UserLocationData userLocationData)
	{
		...
		String builder = userLocationData.getSearchTerm() + CustomerLocationCookieGenerator.LOCATION_SEPARATOR +
