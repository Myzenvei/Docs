...
public class SearchPageController extends AbstractSearchPageController
{
	...
	@RequestMapping(method = RequestMethod.GET, params = "query")
	public String refineSearch(@RequestParam("query") final String searchQuery,
	...
	public SearchResultsData<ProductData> jsonSearchResults(@RequestParam("query") final String searchQuery,
			@RequestParam(value = "page", defaultValue = "0") final int page,
			@RequestParam(value = "show", defaultValue = "Page") final ShowMode showMode,
	...
	public FacetRefinement<SearchStateData> getFacets(@RequestParam("query") final String searchQuery,
			@RequestParam(value = "page", defaultValue = "0") final int page,
			@RequestParam(value = "show", defaultValue = "Page") final ShowMode showMode,
			@RequestParam(value = "sort", required = false) final String sortCode) throws CMSItemNotFoundException
	{
