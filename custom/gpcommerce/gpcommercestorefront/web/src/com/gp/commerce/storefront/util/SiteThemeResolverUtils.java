 ...
 */
package com.gp.commerce.storefront.util;
...
public class SiteThemeResolverUtils
{
	...
	public String resolveThemeForCurrentSite()
	{
		...
		if (currentSite != null)
		{
			return combineSiteAndTheme(null !=uiExperienceLevel? uiExperienceLevel.getCode():"", currentSite.getUid(), getThemeNameForSite(currentSite));
		}
		return null;
	}
