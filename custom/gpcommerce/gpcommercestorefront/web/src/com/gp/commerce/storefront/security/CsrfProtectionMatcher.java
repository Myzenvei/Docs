...
public class CsrfProtectionMatcher implements RequestMatcher
{
	...
	private static final String ADD_PAYMENT_INFO = "addPaymentInfo";
	...
	private final HashSet<String> csrfProtectedMethodSet = new HashSet<String>(Arrays.asList(POST_METHOD));

	@Override
	public boolean matches(final HttpServletRequest request)
	{
		if (csrfProtectedMethodSet.contains(request.getMethod()) && !request.getServletPath().contains(ADD_PAYMENT_INFO))
		{
