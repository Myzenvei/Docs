...
import com.gp.commerce.storefront.controllers.cms.AbstractAcceleratorCMSComponentController;
		...
		extends AbstractCMSComponentController<T>
{
	...
	protected String handleComponent(final HttpServletRequest request, final HttpServletResponse response,
			final Model model, final T component) // NOSONAR
	{
		...
		model.addAttribute("i18n", jsonResp);
