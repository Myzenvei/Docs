 ...
 */
package com.gp.commerce.storefront.controllers;
...
public interface ControllerConstants
{
	...
	interface Actions
	{
		interface Cms // NOSONAR
		{
			...
			String GPImageTileComponent = _Prefix + GPImageTileComponentModel._TYPECODE + _Suffix; // NOSONAR
			String GPBannerComponent = _Prefix + GPBannerComponentModel._TYPECODE + _Suffix; // NOSONAR
			String GPBrandBarComponent = _Prefix + GPBrandBarComponentModel._TYPECODE + _Suffix; // NOSONAR
	...
	interface Views
	{
		...
		interface Pages
		{
			interface Account // NOSONAR
			{
				...
				String PaymentPage = "pages/account/paymentPage"; // NOSONAR
			}
			...
			interface Redirect // NOSONAR
			{
				String RedirectPage = "pages/account/redirectPage"; // NOSONAR
			}

			interface Bundle
			{
				String gpStartBundlePage="pages/bundle/startbundle";
			}
		}
