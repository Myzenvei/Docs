...
/**
 * Filter that initializes the session for the gpcommercestorefront. This is a spring configured filter that is
...
public class StorefrontFilter extends OncePerRequestFilter
{
	...
	public static final String SOLDTO_ROOTCATEGORY = "soldToRootcategory";
	public static final String SOLDTO_UNITID = "soldToUnitId";
			...
			final FilterChain filterChain) throws IOException, ServletException
	{
		...
		if(null == sessionService.getAttribute(GpcommerceCoreConstants.SOLD_TO_ID) && null == sessionService.getAttribute(SOLDTO_ROOTCATEGORY))
		{
			sessionService.setAttribute(SOLDTO_ROOTCATEGORY, "DEFAULT");
			sessionService.setAttribute(SOLDTO_UNITID, "DEFAULT");
		}
