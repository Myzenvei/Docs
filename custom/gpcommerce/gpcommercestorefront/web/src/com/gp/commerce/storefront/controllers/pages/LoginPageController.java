...
public class LoginPageController extends AbstractLoginPageController
{
	...
	private static final String GPEMPLOYEE_REDIRECT_URL = "/redirect?code=";
			...
			throws CMSItemNotFoundException
	{
		...
		String kochapiuri = configurationService.getConfiguration().getString(KOCHAPI_UI_URI);
		String kochclientid = configurationService.getConfiguration().getString(KOCH_CLIENTID);

		String kochurl = kochapiuri + CLIENT_ID + kochclientid + RESPONSE_TYPE;
	...
	{
		String redirectUrl = configurationService.getConfiguration().getString("gpemployee.redirect.url",GPEMPLOYEE_REDIRECT_URL);
		if (StringUtils.isNotBlank(referer) && !StringUtils.endsWith(referer, "/login")
				&& StringUtils.contains(referer, request.getServerName()) && !StringUtils.contains(referer, redirectUrl))
		{
