...
<!-- <vx-cart-suggestions title='${title}'></vx-cart-suggestions> -->
<vx-cart-suggestions title='${title}' uid='${uid}' :is-favorites="${isFavoritesEnabled}"
	:is-bazaar-voice="'${isBazaarVoiceEnabled}'" :i18n="messages.searchBrowse.productTile"></vx-cart-suggestions>
