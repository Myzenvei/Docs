<%@ page trimDirectiveWhitespaces="true"%>
					...
					<template:page pageTitle="${pageTitle}">
						...
						<div class="container-fluid pdp-page">
							<div class="row">
								<c:choose>
									<c:when test="${siteUid == 'gpemployee'}">
										<cms:pageSlot position="LeftContentSlot" var="comp" element="div" class="col-xs-12 col-sm-7 productDetailsPageSection1">
											<cms:component component="${comp}" element="div" class="productDetailsPageSection1-component" />
										</cms:pageSlot>
										<cms:pageSlot position="RightContentSlot" var="comp" element="div" class="col-xs-12 col-sm-5 productDetailsPageSection2">
	...
	<div itemscope style="display: none;" itemtype="http://schema.org/Product">
		<span itemprop="name">"${productName}"</span> <span itemprop="price">"${price}"</span>
		<span itemprop="url">"${productUrl}"</span> <span itemprop="image">"${image}"</span>
