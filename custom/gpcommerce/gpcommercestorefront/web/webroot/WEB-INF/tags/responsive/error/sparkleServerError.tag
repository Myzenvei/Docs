...
<head>
    ...
    <link rel="icon" href="/_ui/responsive/theme-alpha/images/sparkle/sparkle-favicon.ico">
    <title>Sparkle</title>
    <style type="text/css">
     @font-face {
...
<div class='container'>
    <header>
      <a><img class='logo' src='${contextPath}/_ui/responsive/common/images/sparkle-logo.svg'></a>
    </header>
