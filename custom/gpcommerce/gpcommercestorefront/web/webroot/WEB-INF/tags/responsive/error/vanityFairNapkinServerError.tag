...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="https://cloud.typography.com/6228154/7125212/css/fonts.css" />  <title>Vanity Fair</title>
  <title>Vanity Fair</title>
  <link rel="icon" href="/_ui/responsive/theme-alpha/images/vanityfairnapkins/favicon.png" sizes="16x16" type="image/png">
  <style type="text/css">
    html,
    body {
      margin: 0;
  ...
  <div class='container'>
    <header>
      <div class="header-inner-wrapper">
        <a href="/"><img class='logo' src="${contextPath}/_ui/responsive/common/images/vanity-fair-logo.svg"></a>
      </div>
    </header>
