...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/gpcommercestorefront/electronics/en",
						"https://electronics.local:9002/gpcommercestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/gpcommercestorefront/electronics/en",
						"https://electronics.local:9002/gpcommercestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/gpcommercestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/gpcommercestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/gpcommercestorefront/electronics/en",
						"https://electronics.local:9002/gpcommercestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/gpcommercestorefront",
						"https://electronics.local:9002/gpcommercestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/gpcommercestorefront",
						"https://electronics.local:9002/gpcommercestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/gpcommercestorefront/electronics/en",
						"https://electronics.local:9002/gpcommercestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
	...
	protected String executeCalculateRelativeRedirectUrl(final String urlEncodingAttrs, final String contextPath, final String url)
	{
		...
		return cache.calculateRelativeRedirectUrl(contextPath, url,"gpemployee");
	}
