 ...
 */
package com.gp.stocknotifyoccaddon.validator;
...
public class StockNotificationValidator
{
	...
	public void validateProuctStockLevel(final String productCode) throws StockNotificationException
	{
		try
		{
			...
			if (product != null && !StockLevelStatus.OUTOFSTOCK.equals(product.getStock().getStockLevelStatus()) && !MaterialStatusEnum.COMING_SOON.getCode().equalsIgnoreCase(product.getMaterialStatus()))
			{
