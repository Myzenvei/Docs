...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			"GPStockLevelStatusCronJob",
			"CronJob",
			com.gp.stocknotifyoccaddon.jalo.GPStockLevelStatusCronJob.class,
			null,
			false,
			null,
			false
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_GPStockLevelStatusCronJob_site();
			

	}

	
	public void single_createattr_GPStockLevelStatusCronJob_site() throws JaloBusinessException
	{
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performCreateObjects
			...
			single_setAttributeProperties_GPStockLevelStatusCronJob_site();
		
	}


		
						public void single_setAttributeProperties_GPStockLevelStatusCronJob_site() throws JaloBusinessException
						{
