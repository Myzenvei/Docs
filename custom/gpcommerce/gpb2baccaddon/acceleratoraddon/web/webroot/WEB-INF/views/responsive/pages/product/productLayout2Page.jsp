...
<template:page pageTitle="${pageTitle}">
	...
	<div itemscope  itemtype="http://schema.org/Product">
		<span style="display: none;" itemprop="name">"${productName}"</span><span  style="display: none;"itemprop="price">"${price}"</span>
		<span style="display: none;" itemprop="url">"${productUrl}"</span> <span style="display: none;" itemprop="image">"${image}"</span>
		<span style="display: none;" itemprop="availability">"${availability}"</span>
		<span style="display: none;" itemprop="priceCurrency">"${priceCurrency}"</span> 
		<span style="display: none;" itemprop="description">"${description}"</span>
