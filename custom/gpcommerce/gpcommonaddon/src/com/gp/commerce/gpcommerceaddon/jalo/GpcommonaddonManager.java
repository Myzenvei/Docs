...
/**
 * This is the extension manager of the Gpcommonaddon extension.
 */
public class GpcommonaddonManager extends GeneratedGpcommonaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(GpcommonaddonManager.class.getName());
	 ...
	 */
	public static GpcommonaddonManager getInstance()
	{
		return (GpcommonaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				GpcommonaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GpcommonaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GpcommonaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of GpcommonaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of GpcommonaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
