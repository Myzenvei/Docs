 ...
 */
public class SubscriptionOrderConfirmationContext extends GPAbstractEmailContext<OrderProcessModel>
{
	...
	public void init(final OrderProcessModel orderProcessModel, final EmailPageModel emailPageModel)
	{
		...
		put(CREATEDDATE, getCreateDate(orderProcessModel.getOrder().getCreationtime()));
