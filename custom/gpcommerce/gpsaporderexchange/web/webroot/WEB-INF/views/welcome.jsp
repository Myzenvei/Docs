...
<html>
<head>
    <title>Welcome to gpsaporderexchange</title>
    <link rel="stylesheet" href="<c:url value="/static/gpsaporderexchange-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "gpsaporderexchange" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/gpsaporderexchange-items.xml</b> - here you can model your items</li>
            <li><b>resources/gpsaporderexchange-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/gpsaporderexchange-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/gpsaporderexchange-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/gpsaporderexchange-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
